...
public class FPSController : MonoBehaviour {
    ...
    */
    ...
    public void PlayerTakeDamage(float damage, Vector3 hitDireciton) {
        playerStats.TakeDamage(damage);
        playerUI.GetHitIndicator().SetDirection(hitDireciton);
    }

    public void PlayerTakeStamDrain(float staminaDrain) {
        playerStats.TakeStaminaDrain(staminaDrain);
    }
